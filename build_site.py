...
CSV_DESCRIPTIONS = {
"dollars_actions_by_naics4_category_fy.csv": "Contract obligations and action counts by fiscal year, four-digit NAICS industry, and socioeconomic category, FY2022–FY2026 (FY2026 partial).",
...
<h2>Contact</h2>
<p><a href="mailto:contact@federalmarketplaceindex.org">contact@federalmarketplaceindex.org</a> &middot; Corrections and data questions welcome — see the corrections policy in the
